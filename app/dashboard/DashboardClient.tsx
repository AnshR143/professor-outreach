...
export default function DashboardClient({ profile, researchers, activities, emails }: Props) {
  ...
  const kpis = [
    {
      label: "Researchers Found", value: researchers.length, sub: "Total matches", color: "#304674",
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#304674" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
      bg: "#d8e1e8",
    },
    {
            ...
            <div>
              {researchers.length === 0 ? (
                ...
                <Link key={r.id} href={`/dashboard/researchers/${r.id}`} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 20px", borderBottom: "1px solid #f1f5f9", textDecoration: "none" }}>
                  <div style={{ width: 36, height: 36, borderRadius: "50%", background: "#304674", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 13, fontWeight: 700, flexShrink: 0 }}>
                  ...
                  <div style={{
                    ...
                    border: `2.5px solid ${r.match_score >= 85 ? "#22c55e" : r.match_score >= 70 ? "#304674" : "#f59e0b"}`,
