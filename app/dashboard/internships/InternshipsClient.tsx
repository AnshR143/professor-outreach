    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      {emailContact && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000, padding: 20 }}
          ...
          <div style={{ background: "#fff", borderRadius: 20, border: "4px solid #304674", width: "100%", maxWidth: 600, maxHeight: "90vh", overflowY: "auto", boxShadow: "12px 12px 0px #98bad5" }}
            ...
            <div style={{ padding: "20px 24px 0", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              ...
              <button onClick={() => setEmailContact(null)} style={{ background: "#f1f5f9", border: "2px solid #304674", borderRadius: 8, cursor: "pointer", color: "#304674", padding: "6px", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "2px 2px 0px #304674", transition: "all 0.1s" }}
                onMouseEnter={e => { e.currentTarget.style.transform = "scale(1.1)"; e.currentTarget.style.background = "#fee2e2"; e.currentTarget.style.borderColor = "#dc2626"; e.currentTarget.style.color = "#dc2626" }}
                onMouseLeave={e => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.background = "#fff"; e.currentTarget.style.borderColor = "#304674"; e.currentTarget.style.color = "#304674" }}>
                <X size={18} strokeWidth={3} />
              </button>
