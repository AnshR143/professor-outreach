...
function scoreColor(score: number) {
  ...
  if (score >= 70) return { border: "#304674", bg: "#d8e1e8", text: "#304674" }
        ...
        {filtered.length === 0 && (
          <div style={{ textAlign: "center", padding: "72px 20px", background: "#fff", borderRadius: 16, border: "1px solid #e2e8f0" }}>
            ...
            {researchers.length === 0 ? (
              <button
                onClick={() => setShowFind(true)}
                style={{ padding: "10px 28px", background: "#304674", color: "#fff", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: "pointer" }}
              >
                Find Researchers
              </button>
            ) : search.length > 0 ? (
              <button
                onClick={() => setShowFind(true)}
                style={{ padding: "10px 28px", background: "#304674", color: "#fff", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 8, margin: "0 auto" }}
              >
            ...
            {filtered.map(r => {
              ...
              return (
                <div key={r.id} style={{ position: "relative" }}>
                  ...
                  <div
                    style={{ background: "#fff", borderRadius: 14, border: "2px solid #304674", padding: "18px 20px", cursor: "pointer", transition: "transform 0.15s, box-shadow 0.15s", boxShadow: "4px 4px 0px #304674", display: "flex", flexDirection: "column", gap: 12, height: "100%", boxSizing: "border-box" }}
                    onMouseEnter={e => { e.currentTarget.style.boxShadow = "6px 6px 0px #304674"; e.currentTarget.style.transform = "translate(-2px, -2px)" }}
                    onMouseLeave={e => { e.currentTarget.style.boxShadow = "4px 4px 0px #304674"; e.currentTarget.style.transform = "translate(0, 0)" }}
                  >
                    {/* Name + score + date */}
                    ...
                    {/* Why match */}
                    {r.why_match && (
                      <div style={{ fontSize: 11, color: "#475569", lineHeight: 1.5, background: "#f8fafc", borderRadius: 8, padding: "8px 10px", borderLeft: "3px solid #304674" }}>
                        {r.why_match}
                      </div>
                    )}
